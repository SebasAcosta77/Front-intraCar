...
router.get('/list', roleMiddleware(2, 3), getAllController);
...
router.get('/agente/:id_agente', roleMiddleware(1, 3), getByAgenteController);

// POST /api/v1/documentos/upload/:id_afiliado — Agente sube documento (rol 1)
router.post('/upload/:id_afiliado', roleMiddleware(1, 3), upload.single('archivo'), uploadController);
...
router.post('/backoffice/upload/:id_afiliado', roleMiddleware(2, 3), upload.single('archivo'), uploadController);

router.post('/backoffice/texto/:id_afiliado', roleMiddleware(2, 3), uploadTextoController);
